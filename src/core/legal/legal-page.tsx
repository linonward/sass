...
export function LegalPage({ document }: { document: LegalDocument }) {
  ...
  return (
    <article
      lang="en"
      className="text-foreground/90 [&_a]:text-primary [&_h2]:text-foreground [&_h3]:text-foreground [&_strong]:text-foreground mx-auto max-w-3xl px-4 py-12 text-[0.9375rem] leading-7 sm:py-16 [&_a]:font-medium [&_a]:break-words [&_a]:underline [&_a]:underline-offset-4 [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:scroll-mt-20 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:font-semibold [&_li]:mt-1.5 [&_p]:mt-4 [&_strong]:font-semibold [&_ul]:mt-4 [&_ul]:list-disc [&_ul]:pl-6"
    >
